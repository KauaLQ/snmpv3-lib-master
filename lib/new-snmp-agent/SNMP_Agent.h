...
#include "USM.h" // <<< 1. INCLUIR USM.h

#include <list>
#include <deque>
#include <string>

#define MAX_V3_USERS 5 // Define um número máximo de usuários v3
...
class SNMPAgent {
    public:
        ...
        // <<< 2. ADICIONAR NOVA FUNÇÃO PÚBLICA PARA CONFIGURAR USUÁRIOS V3
        bool addUser(const char* userName, SNMPV3SecurityLevel level, 
                 SNMPV3AuthProtocol authProto, const char* authPass, 
                 SNMPV3PrivProtocol privProto = PRIV_PROTOCOL_DES, const char* privPass = "");
    ...
    private:
        ...
        // <<< 3. ADICIONAR NOVOS MEMBROS PARA O SNMPv3
        USM usm;
        SNMPV3User _v3_users[MAX_V3_USERS];
        int _num_v3_users = 0;
};
